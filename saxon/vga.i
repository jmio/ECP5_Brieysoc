...
void vga_init()
{
    vga_stop(((Vga_Reg*)(0xF0030000)));
    ((Vga_Reg*)(0xF0030000))->TIMING = vga_h800_v480_r60;
    ((Vga_Reg*)(0xF0030000))->FRAME_SIZE = (800)*(480)*2-1;
    ((Vga_Reg*)(0xF0030000))->FRAME_BASE = (uint32_t)((uint16_t *)(0x40000000));
    vga_run(((Vga_Reg*)(0xF0030000)));
}

void vga_clear()
{

 uint32_t *ptr = (uint32_t *)((uint16_t *)(0x40000000));
 for(uint32_t y = 0;y < (480);y++){
  for(uint32_t x = 0;x < (800)/2;x++){
   *ptr++ = 0;
  }
 }
}
